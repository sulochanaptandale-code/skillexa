...
const DashboardLayout = () => {
  ...
  const navigation = [
    ...
    { name: 'Courses', href: '/dashboard/courses', icon: BookOpen, roles: ['admin', 'instructor', 'student'] },
    { name: 'Analytics', href: '/dashboard/analytics', icon: BarChart3, roles: ['admin', 'instructor'] },
    { name: 'Admin Panel', href: '/dashboard/admin', icon: Shield, roles: ['admin'] },
    { name: 'Instructor Panel', href: '/dashboard/instructor', icon: GraduationCap, roles: ['instructor'] },
  ];
        ...
        <div className={`relative flex-1 flex flex-col max-w-xs w-full bg-white transform transition ease-in-out duration-300 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
          ...
          <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            <div className="flex-shrink-0 flex items-center px-4">
              <h1 className="text-xl font-bold text-gray-900">RBAC Platform</h1>
            </div>
            ...
            <div className="flex-shrink-0 flex border-t border-gray-200 p-4">
              <div className="flex items-center w-full">
                ...
                <button
                  ...
                  className="ml-2 p-1 rounded-full text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-violet-500"
                >
